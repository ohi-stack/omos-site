...
final class OMOS_Core_Tools {
    ...
    private function __construct() {
        ...
        $this->members = new OMOS_Members_Bridge();
        $this->shortcodes = new OMOS_Shortcodes($this->client, $this->members);
        $this->admin = new OMOS_Admin($this->client, $this->shortcodes, $this->members, array($this, 'site_role'));
    }
    ...
    public function register_rest_routes() {
        ...
        register_rest_route('omos/v1', '/members', array(
            'methods'             => 'GET',
            'permission_callback' => function () { return is_user_logged_in(); },
            'callback'            => array($this, 'rest_members'),
        ));
    ...
    public function rest_sync() {
        ...
        return rest_ensure_response(array(
            ...
            'members_integration'  => $this->members->public_status(),
            'authority_boundary'   => 'WordPress does not own provider credentials, Council authority, Human Gate, Decision Records, PostgreSQL, deployments, payments, membership transaction truth, or consequential external actions.',
            'generated_at'         => gmdate('c'),
        ));
    }
    ...
    public function rest_members() {
        return rest_ensure_response($this->members->authenticated_payload());
    }
