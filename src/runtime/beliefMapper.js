...
const STAGES = {
  SEEKER: { id: "seeker", label: "Seeker", description: "Exploring the concept of One God without a formal OneGodian identity.", next: ["Learn", "Explore"] },
  BELIEVER: { id: "believer", label: "Believer", description: "Affirms One God as a primary truth and is considering OneGodian identity.", next: ["Explore", "Declare"] },
  ONEGODIAN: { id: "onegodian", label: "OneGodian", description: "Formally self-identifies as OneGodian and participates in the OneGodian ecosystem.", next: ["Join", "Continue"] },
  ELDER: { id: "elder", label: "Elder", description: "A long-term OneGodian who contributes knowledge, guidance, or community leadership.", next: ["Continue", "Contribute"] },
  ALLY: { id: "ally", label: "OneGodian Ally", description: "A supporter, friend, learner, or respectful observer of OneGodian principles.", next: ["Learn", "Support"] }
};

function clean(value) { return String(value ?? "").trim().toLowerCase(); }
function boolish(value) { return [true, "true", "yes", "1", 1].includes(value); }
